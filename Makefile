...
SOURCES = \
	__init__.py \
	attribute_transfer_to_schema.py attribute_transfer_to_schema_dialog.py

PLUGINNAME = attribute_transfer_to_schema

PY_FILES = \
	__init__.py \
	attribute_transfer_to_schema.py attribute_transfer_to_schema_dialog.py

UI_FILES = attribute_transfer_to_schema_dialog_base.ui
